...
function InvoiceDetailContent() {
  ...
  const networkLabel = chainMeta?.shortName
    ...
    : `CHAIN ${chainId}`
  const explorerUrl = chainMeta?.explorerUrl || 'https://coston2-explorer.flare.network'
