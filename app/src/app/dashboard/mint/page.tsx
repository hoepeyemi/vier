...
/**
 * vier Mint Page - Terminal/Bloomberg Aesthetic
 */
        ...
        <main className="max-w-2xl mx-auto px-6 py-16">
          <div className="terminal-card p-8 text-center">
            ...
            {hash && (
              <div className="mb-8">
                <a
                  href={`${chainMeta?.explorerUrl || 'https://coston2-explorer.flare.network'}/tx/${hash}`}
                  target="_blank"
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="p-4 bg-[#111111] rounded border border-[#1f1f1f]">
                <div className="flex items-center justify-between text-[11px] mb-2">
                  ...
                  <span className="tabular-nums">{chainMeta?.gasLabel || '~$0'} {chainMeta?.nativeCurrency || 'C2FLR'}</span>
                </div>
