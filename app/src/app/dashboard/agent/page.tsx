...
/**
 * vier Agent Page - Terminal/Bloomberg Aesthetic
...
export default function AgentPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] bg-grid noise-overlay scan-line pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="terminal-card p-6">
            ...
            <div className="space-y-2 text-[12px]">
              <div className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-[#10b981] status-pulse" />
                <span className="text-[#e5e5e5]">Running inside Flare Confidential Compute TEE</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-[#10b981] status-pulse" />
                <span className="text-[#e5e5e5]">Signing decisions via FCE identity key</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-[#10b981] status-pulse" />
                <span className="text-[#e5e5e5]">Verifying attestations via Flare FDC</span>
              </div>
            </div>
          </div>
      ...
      {/* Status Bar */}
      <StatusBar status="online" network={networkLabel} />
    </div>
  )
}
