  ...
  useEffect(() => {
    ...
    if (isConnected && address && !previouslyConnected.current) {
      ...
      toast.info("Wallet disconnected", {
        description: "Connect your wallet to use vier",
      })
        ...
        <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            ...
            <Link href="/" className="flex items-center gap-2">
              <img src="/logo.svg" alt="vier" className="w-8 h-8" />
              <span className="font-display font-semibold text-lg tracking-tight hidden sm:inline">vier</span>
            </Link>
