...
## Project Overview
vier is an AI treasury agent for B2B commerce that tokenizes invoices as NFTs on Flare Coston2 and deposits them into yield-generating DeFi strategies.
...
- **Tracks Selected:** x402 Agentic Finance/Payment Track + Flare Coston2 Integrations
