...
- **Cronos Testnet deployment** - Originally built for Flare, pivoted to Cronos for x402 hackathon
...
- Vercel deployment at vier-app.vercel.app
- Has Remotion setup for potential video generation

## Gotchas & Warnings

- PITCH.md and DEMO.md still reference Flare (old hackathon) - need updating
- Live Vercel deployment shows Flare, not Cronos - needs redeploy
- Yields are SIMULATED - don't promise real DeFi returns
- Contracts NOT audited - testnet only

## Reflections

- The pivot from Flare to Cronos went smoothly at code level, but documentation/deployment lags behind
